...
<html>
<head>
<title>Iconic NPC Ravensong Character Generator</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	...
	<link rel="stylesheet" type="text/css" href="css/mcc_ravensong.css">
	<link rel="stylesheet" type="text/css" href="css/mcc_ravensong_post.css">
...
<!-- JQuery -->
  ...
  <script>
	...
	/*
	 Character() - Ravensong Character Constructor
	*/
	function Character() {
	...
	return shaman[6]; 
       ...
       let imgData = "images/ravensong_character_sheet.png";
