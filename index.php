...
<html>
<head>
<title>Launch Page: Ravensong Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="ravensongForm"  target="_blank" method="post">
            ...
            <br/>
                ...
                <span class="formIputDescription8Iconic">Patron A.I.:</span>	
			  <select id="patronAI" name="thePatronAI" class="arifactBoxIconic">			
                <option value="Gaea" selected>Gaea</option>
				<option value="Hexacoda">Hexacoda</option>
				<option value="Achroma">Achroma</option>
				<option value="Hale-e">Hale-e</option>
				<option value="Ukur">Ukur</option>
				<option value="Mangala">Mangala</option>
				<option value="ME10">ME10</option>
				<option value="Tetraplex">Tetraplex</option>
			  </select>
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Ravensong, Level 1</option>
				<option value="02">Ravensong, Level 2</option>
				<option value="03">Ravensong, Level 3</option>
				<option value="04">Ravensong, Level 4</option>
				<option value="05">Ravensong, Level 5</option>
				<option value="06">Ravensong, Level 6</option>
				<option value="07">Ravensong, Level 7</option>
				<option value="08">Ravensong, Level 8</option>
				<option value="09">Ravensong, Level 9</option>
				<option value="10">Ravensong, Level 10</option>
			  </select>
        ...
        {
            $("#ravensongForm").attr('action', "ravensong/ravensong"+ $("#level").val() +  ".php");
        });
